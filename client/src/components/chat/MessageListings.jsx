    ...
    <div className="listings">
      <div className="listings_channels">
        ...
        <ul className="channel_list">
          <li className="channel active"><a className="channel_name"><span className="unread">0</span><span><span className="prefix">#</span>admin</span></a></li>
          <li className="channel"><a className="channel_name"><span className="unread">10</span><span><span className="prefix">#</span>general</span></a></li>
        </ul>
      </div>
